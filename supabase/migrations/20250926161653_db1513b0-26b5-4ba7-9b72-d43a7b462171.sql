-- Fix the get_school_admins_for_current_user function with correct column references
...
BEGIN
  -- Get current user's school_id (fixed: use profiles.id instead of ambiguous id)
  SELECT profiles.school_id INTO user_school_id
